## 🤖 AI Change Summary for PR #12

### Chunk 1/1
## 개요
이 변경 사항은 GitHub Actions 워크플로우와 OpenAI API를 활용하여 Pull Request의 변경 내용을 요약하는 기능을 추가합니다. 새로운 스크립트와 프롬프트 파일이 도입되었으며, 기존의 불필요한 파일이 삭제되었습니다.

## 주요 변경 사항
- **워크플로우 수정**: `.github/workflows/ai-change_summary.yml` 파일에서 조건문을 수정하여 요약 파일을 안전하게 처리하도록 변경.
